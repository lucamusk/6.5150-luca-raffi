...
(define (zip-insert-right zip obj)
  (%make-zipper (zipper-point zip)
                (zipper-left zip)
                (cons obj (zipper-right zip))
                (zipper-trail zip)))

(define (zip-insert-left zip obj)
  (%make-zipper (zipper-point zip)
                (zipper-left zip)
                (cons obj (zipper-right zip))
                (zipper-trail zip)))

(define (zip-update zip fn)
  (%make-zipper (fn (zipper-point zip))
                (zipper-left zip)
                (zipper-right zip)
                (zipper-trail zip)))

(define (zip-swap zip obj) (zip-update zip (constant-procedure obj)))

(define (zip-delete-left zip)
